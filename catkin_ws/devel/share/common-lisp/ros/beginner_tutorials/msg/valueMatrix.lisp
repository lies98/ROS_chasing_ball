...
(cl:defmethod cl:initialize-instance :after ((m <valueMatrix>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'valueMatrix)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-msg:<valueMatrix> is deprecated: use beginner_tutorials-msg:valueMatrix instead.")))
...
(cl:defmethod value-val ((m <valueMatrix>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorials-msg:value-val is deprecated.  Use beginner_tutorials-msg:value instead.")
  (value m))

(cl:ensure-generic-function 'tick-val :lambda-list '(m))
(cl:defmethod tick-val ((m <valueMatrix>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorials-msg:tick-val is deprecated.  Use beginner_tutorials-msg:tick instead.")
  (tick m))

(cl:ensure-generic-function 'option-val :lambda-list '(m))
(cl:defmethod option-val ((m <valueMatrix>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorials-msg:option-val is deprecated.  Use beginner_tutorials-msg:option instead.")
  (option m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<valueMatrix>)))
  ...
  "beginner_tutorials/valueMatrix")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'valueMatrix)))
  "Returns string type for a message object of type 'valueMatrix"
  "beginner_tutorials/valueMatrix")
