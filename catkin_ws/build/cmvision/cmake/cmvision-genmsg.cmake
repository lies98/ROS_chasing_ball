...
set(MSG_I_FLAGS "-Icmvision:/root/catkin_ws/src/cmvision/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
add_custom_target(_cmvision_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "cmvision" "/root/catkin_ws/src/cmvision/msg/Blobs.msg" "cmvision/Blob:std_msgs/Header"
)
...
_generate_msg_cpp(cmvision
  ...
  "${MSG_I_FLAGS}"
  "/root/catkin_ws/src/cmvision/msg/Blob.msg;/opt/ros/kinetic/share/std_msgs/cmake/../msg/Header.msg"
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/cmvision
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/cmvision)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/cmvision\")")
  # install generated code
  install(
